...
Partial Class FrmMiembrosPopup
    ...
    Private Sub InitializeComponent()
        ...
        btnGuardar.Location = New Point(154, 425)
        ...
        Label3.Location = New Point(83, 256)
        Label3.Name = "Label3"
        ...
        tbNombre.Font = New Font("Segoe UI", 12.0F)
        ...
        tbApellido.Font = New Font("Segoe UI", 12.0F)
        ...
        ' dtFechaNacimiento
        ' 
        dtFechaNacimiento.Font = New Font("Segoe UI", 12.0F)
        dtFechaNacimiento.Location = New Point(154, 210)
        dtFechaNacimiento.Name = "dtFechaNacimiento"
        dtFechaNacimiento.Size = New Size(306, 29)
        dtFechaNacimiento.TabIndex = 36
        ' 
        ' cbGenero
        ' 
        cbGenero.Font = New Font("Segoe UI", 12.0F)
        cbGenero.FormattingEnabled = True
        cbGenero.Items.AddRange(New Object() {"Masculino", "Femenino", "Otro", "Prefiero no decir"})
        cbGenero.Location = New Point(155, 256)
        ...
        labelTelefono.Font = New Font("Segoe UI", 12.0F)
        labelTelefono.ForeColor = Color.White
        labelTelefono.Location = New Point(83, 307)
        ...
        Label5.Location = New Point(96, 371)
        Label5.Name = "Label5"
        ...
        ' tbEmail
        ' 
        tbEmail.Font = New Font("Segoe UI", 12.0F)
        tbEmail.Location = New Point(153, 363)
        ...
        tbDni.Font = New Font("Segoe UI", 12.0F)
        ...
        tbTelefono.Font = New Font("Segoe UI", 12.0F)
        tbTelefono.Location = New Point(155, 304)
